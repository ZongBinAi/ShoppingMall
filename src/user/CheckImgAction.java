...
public class CheckImgAction extends ActionSupport{
    ...
    public String execute() throws Exception {
        ...
        JPEGImageEncoder encoder = JPEGCodec.createJPEGEncoder(ServletActionContext.getResponse().getOutputStream());
        encoder.encode(bufferedImage);

        //ImageIO.write(bufferedImage, "jpeg", ServletActionContext.getResponse().getOutputStream());
        return NONE;
    }
